...
$idUser = $obj['idUser']; //Met l'id user que tu récupères ici en json à partir du JS
$pseudoInvite = $obj['pseudo']; //Met le pesudo de user connecte que tu as dans ton JS en JSON
