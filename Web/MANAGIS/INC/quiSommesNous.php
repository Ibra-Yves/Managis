...
<section class="team-section text-center my-5">
    ...
    <!-- Section description -->
    <p class="grey-text w-responsive mx-auto mb-5">Voici l'équipe qui a travaillé afin de mener à bien ce projet</p>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
            ...
            <h5 class="font-weight-bold mt-4 mb-3">Ambroise MOSTIN</h5>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
            ...
            <h5 class="font-weight-bold mt-4 mb-3">Adrien CHELLE</h5>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 mb-md-0 mb-5">
            ...
            <h5 class="font-weight-bold mt-4 mb-3">Nicolas VIROUX</h5>
            <p class="text-uppercase blue-text"><strong>Developpeur + Réseau</strong></p>
        ...
        <div class="col-lg-3 col-md-6">
            ...
            <h5 class="font-weight-bold mt-4 mb-3">Ibrahima YVES</h5>
            <p class="text-uppercase blue-text"><strong>Developpeur + Réseau</strong></p>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
            ...
            <h5 class="font-weight-bold mt-4 mb-3">Dominik FIEDORCZUK </h5>
            <p class="text-uppercase blue-text"><strong>Developpeur web</strong></p>
            <p class="grey-text">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur,
                adipisci sed quia non numquam modi tempora eius.</p>
            <ul class="list-unstyled mb-0">
                <!-- Facebook -->
        ...
        <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
            ...
            <h5 class="font-weight-bold mt-4 mb-3">Maxime LIBER</h5>
            <p class="text-uppercase blue-text"><strong>Developpeur web</strong></p>
            <p class="grey-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem ipsa accusantium
                doloremque rem laudantium totam aperiam.</p>
            <ul class="list-unstyled mb-0">
        ...
        <div class="col-lg-3 col-md-6 mb-md-0 mb-5">
            ...
            <h5 class="font-weight-bold mt-4 mb-3">Remy Vase</h5>
            <p class="text-uppercase blue-text"><strong>Developpeur web</strong></p>
            <p class="grey-text">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
                mollit anim est fugiat nulla id eu laborum.</p>
            <ul class="list-unstyled mb-0">
